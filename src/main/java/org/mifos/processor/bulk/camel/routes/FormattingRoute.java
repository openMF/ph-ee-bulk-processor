...
public class FormattingRoute extends BaseRouteBuilder {
    ...
    public void configure() throws Exception {
         ...
         */
        from(RouteId.FORMATTING.getValue())
                .id(RouteId.FORMATTING.getValue())
                ...
                .otherwise()
                .log("Skipping formatting since standard is set to DEFAULT")
                .end()
                .process(exchange -> {
        ...
        from("direct:format-data")
                .id("direct:format-data")
                .log("Starting route direct:format-data")
                .process(exchange -> {
