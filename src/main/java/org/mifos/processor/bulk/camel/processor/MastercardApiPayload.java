...
@Component
public class MastercardApiPayload implements Function<Exchange, String> {
    ...
    public String apply(Exchange exchange) {
        ...
        try {
            ...
            throw new DTOJsonConversionException(MastercardApiPayload.class, "Unable to convert MastercardPayload to JSON", e);
        }
    }
}
