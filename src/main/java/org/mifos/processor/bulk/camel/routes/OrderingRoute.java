...
public class OrderingRoute extends BaseRouteBuilder {
    ...
    public void configure() {
         ...
         * the [Transaction] array using CsvMapper. 3. Re-order the array generated in step1 based on [orderingField].
        ...
        from("direct:order-data").id("direct:order-data").log("Starting route direct:order-data").process(exchange -> {
